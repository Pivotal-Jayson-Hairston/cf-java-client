...
package org.cloudfoundry.immutables;
...
final class OptionalList<T> {
    ...
    public boolean equals(OptionalList<T> other) {
...
//        Objects.requireNonNull(optional, "optional");  // TODO: Adding this line causes methods to be created twice in generated code

        return optional
            .map(elements -> createSafeList(elements))  // TODO: Method reference name mangling doesn't happen in generated code
            .orElse(null);
    }
...
//    }
    ...
    static final class Builder<T> {
        ...
        // TODO: Adding this method results in a silent generation failure; the class just doesn't get created
